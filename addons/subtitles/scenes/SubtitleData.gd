...
@export var subtitles_padding := 0.0
...
@export var is_character_dialogue := false
...
@export var subtitle_theme_override : Theme = null
...
func _ready() -> void:
	if parent.has_signal("audio_start"):
		parent.connect("audio_start", Callable(self, "trigger_audio_play"))
